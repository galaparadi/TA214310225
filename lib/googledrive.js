...
exports.uploadFile = async (accessToken) => {
    
}

exports.downloadFile = async ({ accessToken, refreshToken, fileId }) => {
...
exports.fileList = async ({ accessToken, refreshToken }) => {
    const oAuth2Client = new google.auth.OAuth2(
        keys.clientID,
        keys.clientSecret,
        "http://localhost/u/auth/google/redirect");
...
exports.fileListOld = async ({ accessToken, refreshToken }) => {
    const oAuth2Client = new google.auth.OAuth2(
        keys.clientID,
        keys.clientSecret,
        "http://localhost/u/auth/google/redirect");
